            ...
            <div className="hero_container">
                <div className="left">
                    <div className="social_icon">
                        ...
                        {/* <Link href="https://www.linkedin.com/in/linkedrealfalcon/">
                        ...
                        {/* <Link href="https://x.com/Monaeem8Naeem">

                            <i className="fa-brands fa-twitter"></i>
                        </Link> */}
                        {/* <Link href="https://github.com/GitRealFalcon">
                    ...
                    <div className="content">
                        ...
                        <p>Certified Financial Advisor offering expert guidance on Insurance, Credit Cards, Loans, Savings Accounts, and more. I help Individuals and Businesses make smart financial choices with personalized advice and trusted solutions href build Link secure financial future.</p>
                        <div className="buttons flex mb-4 flex-wrap gap-3">
                            {/* <Link href="/certificate"><button>Certificates</button></Link> */}
                            <Link href="/services"><button>Services</button></Link>
                            <Link href="https://sales.gromo.in/c/-_0mBdc_ZAyqZwog-I9AB?versionCode=null"><button>CIBIL</button></Link><Link href="https://sales.gromo.in/Mohd/WQLY0055/check-challan"><button>Challan</button></Link>
                        </div>
